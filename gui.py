...
for index in pd.index:
    ...
    noofdigits.append(a.number_of_digits())
    numofpara.append(a.number_of_parameters())
    hasport.append(a.url_has_port_in_string())
    url_pathlength.append(a.url_path_length())




pd['url_length'] = url_length
pd['no_of_digits'] = noofdigits
pd['no_of_parameters'] =numofpara
pd['has_port'] = hasport
pd['url_path_length'] = url_pathlength
